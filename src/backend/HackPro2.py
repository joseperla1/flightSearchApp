...
patterns = [
    ...
    (r'Asia|Latin America|Europe|Mexico|Guatemala|France|United Kingdom|Australia|New Zealand|Africa|Egypt|Ghana|Nigeria|Puerto Rico|Venezuela|New York|Chicago|Houston|Bora Bora|Fiji|Borneo|Marqueses|Amazon Rainforest|Thailand|Brazil|Japan|South Korea|China|Vanuatu|Vietnam|Cook Islands|Micronesia|Gabon|Tocantins|Samoa|Nicaragua|Philippines|Caramoan|Cagayan|Kaoh Rong|Cambodia', ["Here is a list of flights toward your destination"])
]
